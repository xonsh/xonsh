...
* Give a star to `xonsh repository <https://github.com/xonsh/xonsh>`_ and to `xontribs <https://github.com/topics/xontrib>`_ you like.
...
* `Xonsh Fediverse <https://mastodon.online/@xonsh>`_
* `Xonsh Matrix <https://matrix.to/#/#xonsh:matrix.org>`_
* `Xonsh Merch <https://www.hellotux.com/xonsh>`_
