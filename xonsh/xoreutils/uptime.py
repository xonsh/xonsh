...
def boottime():
    ...
    return datetime.fromtimestamp(__boottime or time.time() - __uptime)


def boottime_timestamp():
    """Returns boot time in timestamp format if remotely possible, or None if not."""
    global __boottime
    __uptime = 0
    ...
    return __boottime or time.time() - __uptime
