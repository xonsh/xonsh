...
Examples
 please see :py:class:`xonsh.completers.completer.CompleterAlias` module
"""
...
"""One can import ``Annotated`` from this module which adds a mock when it is not available."""
