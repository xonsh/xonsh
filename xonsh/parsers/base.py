...
class BaseParser:
    ...
    def p_atom_atdot_name(self, p):
        ...
        xonsh_obj = load_attribute_chain("__xonsh__.handler", lineno=lineno, col=col)
        p[0] = ast.Attribute(
            value=xonsh_obj,
            attr=p3.value,
            ctx=ast.Load(),
    ...
    def p_atom_at(self, p):
        ...
        p1 = p[1]
        lineno, col = p1.lineno, p1.lexpos
        p[0] = load_attribute_chain("__xonsh__.handler", lineno=lineno, col=col)
    ...
    def _xonsh_attr_chain(self, lineno, col, first_attr, more_attrs=None):
        ...
        """
        node = load_attribute_chain("__xonsh__.handler", lineno=lineno, col=col)
