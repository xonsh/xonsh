...
- ``dumb`` - special version of readline backend for emacs
- ``best`` - selects the most feature-rich shell available on the user's system

More feature rich option is available by installing the `xontrib-ptk-shell<https://github.com/xonsh/xontrib-ptk-shell>`_.
