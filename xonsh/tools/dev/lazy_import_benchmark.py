...
def create_lazy_import(module_name: str, attribute: Optional[str] = None):
...
def benchmark_optimization():
    ...
    print(f"Improvement: {original_time - lazy_time:.2f}ms ({((original_time - lazy_time) / original_time * 100):.1f}%)")
