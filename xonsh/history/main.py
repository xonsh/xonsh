...
_XH_MAIN_ACTIONS = {"show", "id", "file", "info", "diff", "gc", "flush", "clear"}
...
def _xh_create_parser():
    ...
    # 'clear' subcommand
    subp.add_parser("clear", help="clears session history")
...
def history_main(
    ...
    if ns.action == "show":
        ...
        builtins.__xonsh__.history = builtins.__xonsh__.history.__class__()
